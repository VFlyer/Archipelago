...
ap_skeleton_items = {
    # Progression items
    "All Marathon Modes": ItemData(20050001, ItemClassification.progression),
    "All Versus Modes": ItemData(20050002, ItemClassification.progression),
    "All Sprint Modes": ItemData(20050003, ItemClassification.progression),
    "All Strategy Modes": ItemData(20050004, ItemClassification.progression),
    "All Survivor Modes": ItemData(20050005, ItemClassification.progression),

    # Useful items
    "Mode Skip": ItemData(20050004, ItemClassification.useful),
    
    # Victory is added here since in this organization it needs to be in the default item pool
    "Victory Token": ItemData(20050007, ItemClassification.progression)
}
...
junk_items = {
    # Junk
    "Zitionary Entry": ItemData(20050011, ItemClassification.filler, 0),
    "Motivation": ItemData(20050012, ItemClassification.filler, 0),

    # Traps
    "Left / Right Swap Trap": ItemData(20050013, ItemClassification.trap, 0),
    "Hard Drop / Soft Drop Swap Trap": ItemData(20050014, ItemClassification.trap, 0),
    "Rotation Swap Trap": ItemData(20050015, ItemClassification.trap, 0),
    "Misdrop Trap": ItemData(20050016, ItemClassification.trap, 0),
}
